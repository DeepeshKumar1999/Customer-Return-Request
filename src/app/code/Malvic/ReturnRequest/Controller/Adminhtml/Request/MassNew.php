 ...
 */
namespace Malvic\ReturnRequest\Controller\Adminhtml\Request;
...
class MassNew extends \Magento\Backend\App\Action
{
     ...
     * @see _isAllowed()
     */
    public const ADMIN_RESOURCE = "Malvic_ReturnRequest::listing";
     ...
     * @param \Malvic\ReturnRequest\Model\ResourceModel\ReturnRequest\CollectionFactory $collectionFactory
     */
    public function __construct(
        ...
        protected \Malvic\ReturnRequest\Model\ResourceModel\ReturnRequest\CollectionFactory $collectionFactory
    ) {
